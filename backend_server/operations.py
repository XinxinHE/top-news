...
# MQ for click log
LOG_CLICKS_TASK_QUEUE_URL = 'amqp://qczvzoxl:-b4uqKm8XO822U8ZZlluXaQbCEqfk4gt@wasp.rmq.cloudamqp.com/qczvzoxl'
LOG_CLICKS_TASK_QUEUE_NAME = 'news-log-clicks-task-queue'
...
def getNewsSummariesForUser(user_id, page_num):
    ...
    if redis_client.get(user_id) is not None:
        ...
        db = mongodb_client.get_db()
        total_news = list(db[NEWS_TABLE_NAME].find().sort([('publishAt', -1)]).limit(NEWS_LIMIT))
